...
export const styles = StyleSheet.create({
  ...
  templateLayer: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, zIndex: 4, backgroundColor: '#000' },
  templateSplitHorizontal: { flexDirection: 'row', gap: 2, paddingHorizontal: 1 },
  templateSplitVertical: { flexDirection: 'column', gap: 2, paddingVertical: 1 },
  templateSplitPane: { flex: 1 },
  templatePane: { position: 'relative', backgroundColor: '#000', overflow: 'hidden' },
  stackMainPane: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 142 },
  stackSubPane: { position: 'absolute', left: 0, right: 0, bottom: 142, height: 142, borderTopWidth: 2, borderTopColor: 'rgba(255,255,255,0.24)' },
